...
`TinymistExportSvg`, `TinymistExportPng`, `TinymistExportPdf
`TinymistExportMarkdown`, `TinymistExportText`, `TinymistExportQuery`,
`TinymistExportAnsiHighlight`, `TinymistGetServerInfo`,
`TinymistGetDocumentTrace`, `TinymistGetWorkspaceLabels`, and
`TinymistGetDocumentMetrics`.
    ]],
  },
}
