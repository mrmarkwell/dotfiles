...
-- Plugin related globals
vim.g.snacks_animate = false -- I don't like animations.
...
require("lazy").setup({
  spec = {
    ...
    },
    {
      ...
      ---@type snacks.Config
      opts = {
        bigfile = { enabled = true },   -- Disable some plugins for big files.
        dashboard = { enabled = true }, -- Simple dashboard on open.
      ...
      init = function()
        vim.api.nvim_create_autocmd("User", {
          ...
          callback = function()
            ...
            nmap("<leader>/", Snacks.picker.grep_buffers, "Grep open buffers")
            nmap("<leader>fh", Snacks.picker.recent, "Find in History")
            nmap("<leader>sd", Snacks.picker.diagnostics, "Diagnostics")

            -- Picker shortcuts.
            nmap("<leader>,", Snacks.picker.buffers, "Buffers")
            nmap("<leader>:", Snacks.picker.command_history, "Command History")
            nmap("<leader>sh", Snacks.picker.notifications, "Notification History")
            nmap("<leader>E", function() Snacks.explorer() end, "File Explorer")
            -- find
            nmap("<leader>fb", Snacks.picker.buffers, "Buffers")
            nmap("<leader>fc", function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end, "Find Config File")
            nmap("<leader>ff", Snacks.picker.files, "Find Files")
            nmap("<leader>fg", Snacks.picker.git_files, "Find Git Files")
            nmap("<leader>fp", Snacks.picker.projects, "Projects")
            nmap("<leader>fr", Snacks.picker.recent, "Recent")
            -- git
            ...
            nmap("<leader>gf", Snacks.picker.git_log_file, "Git Log File")
            -- Grep
            nmap("<leader>sb", Snacks.picker.lines, "Buffer Lines")
            nmap("<leader>sB", Snacks.picker.grep_buffers, "Grep Open Buffers")
            nmap("<leader>sg", Snacks.picker.grep, "Grep")
            nmap("<leader>sw", Snacks.picker.grep_word, "Visual selection or word")
            vmap("<leader>sw", Snacks.picker.grep_word, "Visual selection or word")
            -- search
            nmap('<leader>s"', Snacks.picker.registers, "Registers")
            nmap("<leader>s/", Snacks.picker.search_history, "Search History")
            nmap("<leader>sa", Snacks.picker.autocmds, "Autocmds")
            nmap("<leader>sb", Snacks.picker.lines, "Buffer Lines")
            nmap("<leader>sc", Snacks.picker.command_history, "Command History")
            nmap("<leader>sC", Snacks.picker.commands, "Commands")
            nmap("<leader>sd", Snacks.picker.diagnostics, "Diagnostics")
            nmap("<leader>sD", Snacks.picker.diagnostics_buffer, "Buffer Diagnostics")
            nmap("<leader>help", Snacks.picker.help, "Help Pages")
            nmap("<leader>sH", Snacks.picker.highlights, "Highlights")
            nmap("<leader>si", Snacks.picker.icons, "Icons")
            nmap("<leader>sj", Snacks.picker.jumps, "Jumps")
            ...
            nmap("<leader>sp", Snacks.picker.lazy, "Search for Plugin Spec")
            nmap("<leader>sq", Snacks.picker.qflist, "Quickfix List")
            nmap("<leader>sR", Snacks.picker.resume, "Resume")
            nmap("<leader>su", Snacks.picker.undo, "Undo History")
            nmap("<leader>uC", Snacks.picker.colorschemes, "Colorschemes")
            -- lsp
            ...
            nmap("gy", Snacks.picker.lsp_type_definitions, "Goto T[y]pe Definition")
            nmap("<leader>ss", Snacks.picker.lsp_symbols, "LSP Symbols")
            nmap("<leader>sS", Snacks.picker.lsp_workspace_symbols, "LSP Workspace Symbols")
            -- Other
            nmap("<leader>z", function() Snacks.zen() end, "Toggle Zen Mode")
            nmap("<leader>Z", Snacks.zen.zoom, "Toggle Zoom")
            nmap("<leader>.", function() Snacks.scratch() end, "Toggle Scratch Buffer")
            ...
            nmap("<leader>gB", function() Snacks.gitbrowse() end, "Git Browse")
            vmap("<leader>gB", function() Snacks.gitbrowse() end, "Git Browse")
            nmap("<leader>gg", function() Snacks.lazygit() end, "Lazygit")
            nmap("<leader>un", Snacks.notifier.hide, "Dismiss All Notifications")
            nmap("<c-/>", function() Snacks.terminal() end, "Toggle Terminal")
            nmap("<c-_>", function() Snacks.terminal() end, "which_key_ignore")
            nmap("]]", function() Snacks.words.jump(vim.v.count1) end, "Next Reference")
            nmap("[[", function() Snacks.words.jump(-vim.v.count1) end, "Prev Reference")
          end,
        })
      end,
    },
